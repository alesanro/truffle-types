 ...
 * @param path target path to saved artifacts
 */
export declare function removeDeployedNetworkExcept(networks: number[], path: PathLike): Promise<void>;
/**
 * Removes all network except provided ones SYNCHRONOUSLY.
 * @param networks list of network identifiers that should stay in addresses storage
 * @param path target path to saved artifacts
 */
export declare function removeDeployedNetworkExceptSync(networks: number[], path: PathLike): void;
