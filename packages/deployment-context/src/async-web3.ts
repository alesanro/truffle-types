...
/**
 * Defines a class with promisified web3 requests
 */
export class AsyncWeb3 {
    constructor(private web3: Web3) {}

    getEthBalance = (addr: string) =>
        new Promise<BigNumber>((resolve, reject) => {
            this.web3.eth.getBalance(addr, (e, b) =>
                e === undefined || e === null ? resolve(b) : reject(e)
            );
        });

    getTx = (hash: string) =>
        new Promise<Transaction>((resolve, reject) => {
            this.web3.eth.getTransaction(hash, (e, tx) =>
                e === undefined || e === null ? resolve(tx) : reject(e)
            );
        });

    getTxReceipt = (hash: string) =>
        new Promise<TransactionReceipt>((resolve, reject) => {
            this.web3.eth.getTransactionReceipt(hash, (e, tx) =>
                e === undefined || e === null ? resolve(tx) : reject(e)
            );
        });
    ...
    sendEth = async (from: string, to: string, value: BigNumber) => {
        return new Promise<string>((resolve, reject) => {
            this.web3.eth.sendTransaction({ from, to, value }, (e, txHash) =>
                e === undefined || e === null ? resolve(txHash) : reject(e)
            );
        });
    };
